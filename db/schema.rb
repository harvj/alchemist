...
ActiveRecord::Schema[7.0].define(version: 2023_04_24_170008) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "deck_sort_pref"
    t.string "combo_sort_pref"
    t.string "side_sort_pref"
